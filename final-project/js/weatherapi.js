...
var requestURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5604473&APPID=f6deef6645c3c3ba07c23bcea37130c3&units=imperial';
...
windSpeed.textContent = list[5].wind.speed;
    ...
    for (var i = 0; i < list.length; i++) {
        ...
        if (time.includes('18:00:00')) {
            ...
            var path = "https://openweathermap.org/img/w/" + icon + ".png";
            console.log(path);
